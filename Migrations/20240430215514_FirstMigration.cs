        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilmSection = table.Column<string>(type: "nvarchar(20)", nullable: false),
                    Quality = table.Column<string>(type: "nvarchar(20)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorieMovies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategorieMovies_Categories_CategoryID",
                        column: x => x.CategoryID,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_CategorieMovies_Movies_MovieID",
                        column: x => x.MovieID,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorSeries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActorSeries_Actors_ActorID",
                        column: x => x.ActorID,
                        principalTable: "Actors",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorieSeries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategorieSeries_Categories_CategoryID",
                        column: x => x.CategoryID,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_CategorieSeries_Series_SeriesID",
                        column: x => x.SeriesID,
                        principalTable: "Series",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavouriteSeries_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeriesLikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SeriesLikes_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_SeriesLikes_Series_SeriesID",
                        column: x => x.SeriesID,
                        principalTable: "Series",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategorieMovies_CategoryID",
                table: "CategorieMovies",
                column: "CategoryID");

            migrationBuilder.CreateIndex(
                name: "IX_CategorieMovies_MovieID",
                table: "CategorieMovies",
                column: "MovieID");

            migrationBuilder.CreateIndex(
                name: "IX_CategorieSeries_CategoryID",
                table: "CategorieSeries",
                column: "CategoryID");

            migrationBuilder.CreateIndex(
                name: "IX_CategorieSeries_SeriesID",
                table: "CategorieSeries",
                column: "SeriesID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavouriteSeries_UserID",
                table: "FavouriteSeries",
                column: "UserID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeriesLikes_SeriesID",
                table: "SeriesLikes",
                column: "SeriesID");

            migrationBuilder.CreateIndex(
                name: "IX_SeriesLikes_UserID",
                table: "SeriesLikes",
                column: "UserID");
